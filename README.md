...
<h3 align="center">Implement Nodejs Rest Api with Express</h3>
  ...
  <br/>
   ...
   a simple web server and then move on to configuring the database, building the Note model and different routes for handling all the CRUD operations.
